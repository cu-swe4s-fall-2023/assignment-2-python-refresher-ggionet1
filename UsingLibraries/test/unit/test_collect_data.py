...
class Test_clean_data(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.agrofood_bad_colnames = "../data/agrofood_test_data_wrongcol.csv"
        self.pd_agrofood = pd.read_csv("../data/agrofood_test_data.csv")
        self.pd_gdp = pd.read_csv("../data/gdp_test_data.csv")
        cd.clean_dataset(self.agrofood, self.gdp,
                         country1="Austria",
                         country2="Norway",
                         country3="Albania",
                         country4="Belgium",
                         out_path_data="../data/collect_data_output_test.csv")

    @classmethod
    def tearDown(self):
        os.remove("../data/collect_data_output_test.csv")

    def test_load_data(self):
        with self.assertRaises(SystemExit):
            output_data = cd.clean_dataset("doesntexist.csv",
                                           self.gdp,
                                           country1="Austria",
                                           country2="Norway",
                                           country3="Albania",
                                           country4="Belgium")
        with self.assertRaises(SystemExit):
            output_data = cd.clean_dataset(self.empty,
                                           self.gdp,
                                           country1="Austria",
                                           country2="Norway",
                                           country3="Albania",
        ...
        with self.assertRaises(ValueError):
            output_data = cd.clean_dataset(self.agrofood_bad_colnames,
                                           self.gdp,
                                           country1="Austria",
                                           country2="Norway",
                                           country3="Albania",
    ...
    def test_output_csv(self):
        self.assertTrue(os.path.exists("../data/collect_data_output_test.csv"))
...
class Test_plot_data(unittest.TestCase):
    ...
    def setUp(self):
        data_notpd = {
            'Area': ['Country1', 'Country2', 'Country3', 'Country4'],
            'Year': [2020, 2021, 2022, 2023],
            'GDP': [1, 2, 3, 4],
            'Average Temperature °C': [25.5, 26.0, 24.8, 27.0],
            'total_emission': [100, 120, 90, 20],
            'cumulative_emission': [100, 220, 310, 330]}
        df = pd.DataFrame(data_notpd)
        df.to_csv("../data/plot_test_data.csv", index=False)
        data_wrongcolname = {
        ...
        df_wrongcolname = pd.DataFrame(data_wrongcolname)
        df_wrongcolname.to_csv(
            "../data/plot_test_data_wrongcolname.csv", index=False)
        cd.plot_data("../data/plot_test_data.csv",
                     country1="Country1",
                     country2="Country2",
                     country3="Country3",
                     country4="Country4",
    ...
    def tearDown(self):
        ...
        os.remove("../data/plot_test_data.csv")
        os.remove("../data/plot_test_data_wrongcolname.csv")

    def test_pd_input(self):
        with self.assertRaises(SystemExit):
            output_data = cd.plot_data("../data/doesntexist.csv",
                                       country1="Country1",
                                       country2="Country2",
                                       country3="Country3",
                                       country4="Country4")
    ...
    def test_col_names(self):
        with self.assertRaises(ValueError):
            output_data = cd.plot_data(
                "../data/plot_test_data_wrongcolname.csv",
                country1="Country1",
                country2="Country2",
                country3="Country3",
                country4="Country4")
    ...
    def test_country_input(self):
        with self.assertRaises(ValueError):
            output_data = cd.plot_data("../data/plot_test_data.csv",
                                       country1=random.randrange(1, 100),
                                       country2=random.randrange(1, 100),
                                       country3=random.randrange(1, 100),
                                       country4=random.randrange(1, 100))
